...
#Dcg + Y1
  ...
  mY="Y1"
  println("Esquema : ",mY)
  input1 = "/Users/jlc/EnElaboracion/Population_LeonardSusskind/BHInfTurbHTens/Turing/data/EDE/summarystats-$Cname-$nR$mY.jls"
  input2= "/Users/jlc/EnElaboracion/Population_LeonardSusskind/BHInfTurbHTens/Turing/data/EDE/mean-posterior$mC-$Cname-$nR$mY.csv"
...
display(pT)
if PLOTFIGS == 1
#    savefig("./PRLfig9Y1.png")
        savefig("./figEDEsoloY1-rev1-v1.png")
end
